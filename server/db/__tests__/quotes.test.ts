...
describe('getQuotes', () => {
  it('returns the quotes array', () => {
    return getQuotes(testDb).then((quotes: JoinedQuote[]) => {
...
describe('getSingleQuote', () => {
  it('returns the correct quote', () => {
    const id = 3
    return getSingleQuote(id, testDb).then((quote: JoinedQuote) => {
...
describe('getQuotesByAuthor', () => {
  it('returns all the quotes by a given author', () => {
    const authId = 28
    return getQuotesByAuthor(authId, testDb).then((quotes: JoinedQuote[]) => {
